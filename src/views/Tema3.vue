...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-8.mt-3
        .cajonAmarillo.bgr-tarjeta-tema1.p-4
           ...
           p En cualquier entorno comunicativo se emplean diversas técnicas para lograr obtener los resultados de un análisis comercial, y así poder descifrar la viabilidad de un proyecto. Por lo general, estas técnicas son frecuentes en las investigaciones de mercado y pueden ser realizadas por una persona, debido a su sencillez y practicidad. Como su nombre lo indica, existen diversas técnicas, por lo cual es prudente conocerlas antes de elegir la herramienta que se va a utilizar en una conversación o investigación.

    .row.mt-5
      p En la actualidad, la información personal ha adquirido mucho valor, ya que puede ser muy útil para cualquier empresa de cualquier sector, al brindar y generar conocimiento a las diferentes áreas de #[i marketing], ventas y servicio al cliente. 
    ...
    .row.mt-5
      p Para lograr la aplicabilidad de la comunicación asertiva en cualquier entorno se hace necesario tener en cuenta las siguientes recomendaciones:        

    .tarjeta.tarjeta--gris.p-4.bgr1-tema3
      PasosB.color-acento-botones
        .row.justify-content-center.align-items-center
          .col-md-8.mb-md-0
            p #[b Lugar indicado]
            p Se debe elegir el lugar indicado para llevar a cabo una conversación y que sea pertinente el tema, con relación al entorno donde se ejecute.
        ...
        .row.justify-content-center.align-items-center
          .col-md-8.mb-md-0
            p #[b Entorno]
            p Identificar las necesidades que se tienen en el entorno y que pueden influir de alguna forma en el tema a tratar.
        ...
        .row.justify-content-center.align-items-center
          .col-md-8.mb-md-0
            p #[b Voz segura]
            p Se debe manejar un tono de voz seguro, con tonalidad firme, sin altibajos, tartamudeos, muletillas o divagaciones.
        ...
        .row.justify-content-center.align-items-center
          .col-md-8.mb-md-0
            p #[b Dominio del tema a tratar]
            p Al momento de empezar un diálogo, el emisor del mensaje debe tener un gran dominio del tema a tratar.
        ...
        .row.justify-content-center.align-items-center
          .col-md-8.mb-md-0
            p #[b Mensaje neutral]
            p La posición del transmisor del mensaje debe ser neutral y no puede tener inclinación hacia alguno de los diferentes puntos de vista.
        ...
        .row.justify-content-center.align-items-center
          .col-md-8.mb-md-0
            p #[b Reconocer los errores de los participantes]
            p Se debe aprender a reconocer los errores, defectos y virtudes de las personas con las que se lleve a cabo la conversación; esta retroalimentación permitirá el mejoramiento personal y laboral de todas las partes.
